...
We use [FuxiCTR-v1.0.2](fuxictr_url) for this experiment. See model code: [LorentzFM](https://github.com/xue-pai/FuxiCTR/blob/v1.0.2/fuxictr/pytorch/models/LorentzFM.py).
