...
A notebook to benchmark AFM on Criteo_x4_001 dataset.
...
3. Download the hyper-parameter configuration file: [AFM_criteo_x4_tuner_config_01.yaml](./AFM_criteo_x4_tuner_config_01.yaml)
...
4. Run the following script to reproduce the result. 
  ...
  python run_param_tuner.py --config YOUR_PATH/AFM_criteo_x4_tuner_config_01.yaml --tag 010 --gpu 0
  ```
