...
3. Download the hyper-parameter configuration file: [HFM+_criteo_x4_tuner_config_08.yaml](./002/HFM+_criteo_x4_tuner_config_08.yaml)
...
4. Run the following script to reproduce the result. 
  ...
  python run_param_tuner.py --config YOUR_PATH/002/HFM+_criteo_x4_tuner_config_08.yaml --tag 001 --gpu 0
  ```
### Results
```python
[Metrics] logloss: 0.439100 - AUC: 0.812733
```
