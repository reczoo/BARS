...
3. Download the hyper-parameter configuration file: [HFM_criteo_x4_tuner_config_01.yaml](./002/HFM_criteo_x4_tuner_config_01.yaml)
...
4. Run the following script to reproduce the result. 
  ...
  python run_param_tuner.py --config YOUR_PATH/002/HFM_criteo_x4_tuner_config_01.yaml --tag 002 --gpu 0
  ```
### Results
```python
