...
3. Download the hyper-parameter configuration file: [FiGNN_kkbox_x4_tuner_config_02.yaml](./FiGNN_kkbox_x4_tuner_config_02.yaml)
...
4. Run the following script to reproduce the result. 
  ...
  python run_param_tuner.py --config YOUR_PATH/FiGNN_kkbox_x4_tuner_config_02.yaml --tag 005 --gpu 0
  ```
