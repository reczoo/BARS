...
3. Download the hyper-parameter configuration file: [FM_criteo_x4_tuner_config_02.yaml](./FM_criteo_x4_tuner_config_02.yaml)
...
4. Run the following script to reproduce the result. 
  ...
  python run_param_tuner.py --config YOUR_PATH/FM_criteo_x4_tuner_config_02.yaml --tag 003 --gpu 0
  ```
