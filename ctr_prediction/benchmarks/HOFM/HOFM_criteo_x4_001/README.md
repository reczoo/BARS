...
3. Both `dataset_config.yaml` and `model_config.yaml` files are available in [HOFM_criteo_x4_tuner_config_01](./HOFM_criteo_x4_tuner_config_01). Make sure the data paths in `dataset_config.yaml` are correctly set to what we create in the last step.

4. Run the following script to start.

    ```bash
    cd HOFM_criteo_x4_001
    nohup python run_expid.py --config ./HOFM_criteo_x4_tuner_config_01 --expid HOFM_criteo_x4_001_af6d1a42 --gpu 0 > run.log &
    tail -f run.log
    ```
...
2020-07-10 06:57:28,355 P47106 INFO Load best model: /home/XXX/benchmarks/Criteo/HOFM_criteo/min10/criteo_x4_5c863b0f/HOFM_criteo_x4_5c863b0f_001_cef08737_model.ckpt
