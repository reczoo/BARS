...
A notebook to benchmark LR on Avazu_x4_001 dataset.
...
3. Download the hyper-parameter configuration file: [LR_avazu_x4_tuner_config_01.yaml](./LR_avazu_x4_tuner_config_01.yaml)
...
4. Run the following script to reproduce the result. 
  ...
  python run_param_tuner.py --config YOUR_PATH/LR_avazu_x4_tuner_config_01.yaml --tag 005 --gpu 0
  ```


### Results
```python
[Metrics] logloss: 0.381525 - AUC: 0.777457
```
...
2020-05-03 01:30:06,085 P11439 INFO Load best model: /home/xxx/xxx/OpenCTR1030/benchmarks/Avazu/LR_avazu/min2/avazu_x4_3bbbc4c9/LR_avazu_x4_005_f828a69c_model.ckpt
