...
A notebook to benchmark LR on KKBox_x4_001 dataset.
...
3. Download the hyper-parameter configuration file: [LR_kkbox_x4_tuner_config_06.yaml](./LR_kkbox_x4_tuner_config_06.yaml)
...
4. Run the following script to reproduce the result. 
  ...
  python run_param_tuner.py --config YOUR_PATH/LR_kkbox_x4_tuner_config_06.yaml --tag 008 --gpu 0
  ```


### Results
```python
[Metrics] logloss: 0.574564 - AUC: 0.767785
```
...
2020-04-06 06:23:05,701 P31634 INFO Load best model: /home/xxx/xxx/OpenCTR1030/benchmarks/KKBox/LR_kkbox/kkbox_x4_002_c5c9c6e3/LR_kkbox_x4_008_5ea0ce9c_model.ckpt
