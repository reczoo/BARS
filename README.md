...
| WWW'21 | FmFM | [FM^2: Field-matrixed Factorization Machines for Recommender Systems](https://arxiv.org/abs/2102.12994v2) [**Yahoo**] | :heavy_check_mark: |
| WWW'21 | DCN_v2 | [DCN V2: Improved Deep & Cross Network and Practical Lessons for Web-scale Learning to Rank Systems](https://arxiv.org/pdf/2008.13535.pdf) [**Google**] | :heavy_check_mark: |

## Call for Contributions

We welcome any contribution to help improve Open-Match-Benchmark. Check the [guide on how to contribute](https://github.com/xue-pai/Open-CTR-Benchmark/blob/master/CONTRIBUTING.md).
