...
4. Run the following script to start.
    ...
    ```bash
    cd HFM_criteo_x4_002
    nohup python run_expid.py --config ./HFM_criteo_x4_tuner_config_01 --expid HFM_criteo_x4_002_bc5f3953 --gpu 0 > run.log &
    tail -f run.log
    ```
...
2020-05-15 11:19:07,746 P22672 INFO Load best model: /home/XXX/FuxiCTR/benchmarks/Criteo/HFM_criteo/criteo_x4_001_be98441d/HFM_criteo_x4_002_f397374f_criteo_x4_001_be98441d_model.ckpt
