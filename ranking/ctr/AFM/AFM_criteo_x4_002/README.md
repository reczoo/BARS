...
4. Run the following script to start.
    ...
    ```bash
    cd AFM_criteo_x4_002
    nohup python run_expid.py --config ./AFM_criteo_x4_tuner_config_01 --expid AFM_criteo_x4_011_4bd97d26 --gpu 0 > run.log &
    tail -f run.log
    ```
...
2020-01-06 09:37:59,168 P25726 INFO Load best model: /home/XXX/benchmarks/Criteo/AFM_criteo/criteo_x4_001_be98441d/AFM_criteo_x4_011_4bd97d26_criteo_x4_001_be98441d_model.ckpt
