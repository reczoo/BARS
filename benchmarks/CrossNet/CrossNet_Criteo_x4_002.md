...
A notebook to benchmark CrossNet on Criteo_x4_002 dataset.
...
3. Download the hyper-parameter configuration file: [CrossNet_criteo_x4_tuner_config_12.yaml](./002/CrossNet_criteo_x4_tuner_config_12.yaml)
...
4. Run the following script to reproduce the result. 
  ...
  python run_param_tuner.py --config YOUR_PATH/002/CrossNet_criteo_x4_tuner_config_12.yaml --tag 002 --gpu 0
  ```

### Results
```python
[Metrics] logloss: 0.446832 - AUC: 0.804716
```
