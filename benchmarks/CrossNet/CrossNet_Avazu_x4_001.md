...
A notebook to benchmark CrossNet on Avazu_x4_001 dataset.
...
3. Download the hyper-parameter configuration file: [CrossNet_avazu_x4_tuner_config_11.yaml](./CrossNet_avazu_x4_tuner_config_11.yaml)
...
4. Run the following script to reproduce the result. 
  ...
  python run_param_tuner.py --config YOUR_PATH/CrossNet_avazu_x4_tuner_config_11.yaml --tag 039 --gpu 0
  ```
