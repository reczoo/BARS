...
3. Download the hyper-parameter configuration file: [FiGNN_criteo_x4_tuner_config_01.yaml](./FiGNN_criteo_x4_tuner_config_01.yaml)
...
4. Run the following script to reproduce the result. 
  ...
  python run_param_tuner.py --config YOUR_PATH/FiGNN_criteo_x4_tuner_config_01.yaml --tag 006 --gpu 0
  ```
