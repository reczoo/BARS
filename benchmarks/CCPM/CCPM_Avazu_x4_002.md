...
3. Download the hyper-parameter configuration file: [CCPM_avazu_x4_tuner_config_01.yaml](./CCPM_avazu_x4_tuner_config_01.yaml)
...
4. Run the following script to reproduce the result. 
  ...
  python run_param_tuner.py --config YOUR_PATH/CCPM_avazu_x4_tuner_config_01.yaml --tag 025 --gpu 0
  ```
