...
3. Download the hyper-parameter configuration file: [DeepCross_kkbox_x4_tuner_config_02.yaml](./DeepCross_kkbox_x4_tuner_config_02.yaml)
...
4. Run the following script to reproduce the result. 
  ...
  python run_param_tuner.py --config YOUR_PATH/DeepCross_kkbox_x4_tuner_config_02.yaml --tag 020 --gpu 0
  ```
