...
3. Download the hyper-parameter configuration file: [InterHAt_avazu_x4_tuner_config_05.yaml](./InterHAt_avazu_x4_tuner_config_05.yaml)
...
4. Run the following script to reproduce the result. 
  ...
  python run_param_tuner.py --config YOUR_PATH/InterHAt_avazu_x4_tuner_config_05.yaml --tag 001 --gpu 0
  ```
