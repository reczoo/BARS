...
A notebook to benchmark InterHAt on Criteo_x4_002 dataset.
...
3. Download the hyper-parameter configuration file: [InterHAt_criteo_x4_tuner_config_11.yaml](./002/InterHAt_criteo_x4_tuner_config_11.yaml)
...
4. Run the following script to reproduce the result. 
  ...
  python run_param_tuner.py --config YOUR_PATH/002/InterHAt_criteo_x4_tuner_config_11.yaml --tag 004 --gpu 0
  ```
### Results
```python
[Metrics] logloss: 0.440131 - AUC: 0.811671
```
...
2020-06-04 09:20:29,055 P47589 INFO Load best model: /home/xxx/xxx/OpenCTR1030/benchmarks/Criteo/InterHAt_criteo/criteo_x4_001_be98441d/InterHAt_criteo_x4_001_be98441d_004_e0bea572_model.ckpt
