...
A notebook to benchmark LR on Avazu_x4_002 dataset.
...
3. Download the hyper-parameter configuration file: [LR_avazu_x4_tuner_config_02.yaml](./002/LR_avazu_x4_tuner_config_02.yaml)
...
4. Run the following script to reproduce the result. 
  ...
  python run_param_tuner.py --config YOUR_PATH/002/LR_avazu_x4_tuner_config_02.yaml --tag 004 --gpu 0
  ```


### Results
```python
[Metrics] logloss: 0.379905 - AUC: 0.780441
```
...
2020-02-24 06:09:17,604 P30759 INFO Load best model: /home/xxx/xxx/OpenCTR1030/benchmarks/Avazu/LR_avazu/avazu_x4_001_d45ad60e/LR_avazu_x4_003_ff0c15bc_avazu_x4_001_d45ad60e_model.ckpt
