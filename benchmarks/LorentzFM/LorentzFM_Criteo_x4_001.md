...
A notebook to benchmark LorentzFM on Criteo_x4_001 dataset.
...
3. Download the hyper-parameter configuration file: [LorentzFM_criteo_x4_tuner_config_02.yaml](./LorentzFM_criteo_x4_tuner_config_02.yaml)
...
4. Run the following script to reproduce the result. 
  ...
  python run_param_tuner.py --config YOUR_PATH/LorentzFM_criteo_x4_tuner_config_02.yaml --tag 001 --gpu 0
  ```
...
### Results
```python
[Metrics] logloss: 0.443359 - AUC: 0.808346
```
...
2020-07-20 16:08:14,899 P24362 INFO Load best model: /home/xxx/xxx/OpenCTR1030/benchmarks/Criteo/LorentzFM_criteo/min10/criteo_x4_5c863b0f/LorentzFM_criteo_x4_5c863b0f_001_86f261de_model.ckpt
