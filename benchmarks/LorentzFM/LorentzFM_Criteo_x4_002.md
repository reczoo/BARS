...
A notebook to benchmark LorentzFM on Criteo_x4_002 dataset.
...
3. Download the hyper-parameter configuration file: [LorentzFM_criteo_x4_tuner_config_02.yaml](./002/LorentzFM_criteo_x4_tuner_config_02.yaml)
...
4. Run the following script to reproduce the result. 
  ...
  python run_param_tuner.py --config YOUR_PATH/002/LorentzFM_criteo_x4_tuner_config_02.yaml --tag 002 --gpu 0
  ```

### Results
```python
[Metrics] logloss: 0.441322 - AUC: 0.810550
```
...
2020-02-21 18:39:34,535 P7007 INFO Load best model: /home/hispace/container/data/xxx/FuxiCTR/benchmarks/Criteo/LorentzFM_criteo/criteo_x4_001_be98441d/LorentzFM_criteo_x4_002_235e40ca_criteo_x4_001_be98441d_model.ckpt
